using EmployeeCrud_Using_Ajaxcall.Models;
using OfficeOpenXml;
using System;
...
namespace EmployeeCrud_Using_Ajaxcall.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public ActionResult ExportToExcel()
        {
            ...
            using (var package = new ExcelPackage())
            {
                ...
                worksheet.Cells["L1"].Value = "DateOfBirth"; // Corrected column name
                worksheet.Cells["M1"].Value = "MobileNumber"; // Corrected column name
                ...
                foreach (var employee in employees)
                {
                    ...
                    worksheet.Cells["L" + row].Value = employee.DateOfBirth; // Corrected column name
                    worksheet.Cells["M" + row].Value = employee.MobileNumber; // Corrected column name
